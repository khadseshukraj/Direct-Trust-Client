...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DtClinicUserMappingComponent", function() { return DtClinicUserMappingComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/layout/services/application-header.service */ "./src/app/layout/services/application-header.service.ts");
/* harmony import */ var src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/storage-helper.service */ "./src/app/core/services/storage-helper.service.ts");
/* harmony import */ var src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/layout/services/sidebar.service */ "./src/app/layout/services/sidebar.service.ts");
...
/* harmony import */ var _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../shared/components/modal/ModalStaticClass */ "./src/app/modules/shared/components/modal/ModalStaticClass.ts");
/* harmony import */ var src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/modules/emrpage/services/referral.service */ "./src/app/modules/emrpage/services/referral.service.ts");
...
let DtClinicUserMappingComponent = class DtClinicUserMappingComponent {
    constructor(_headerService, _storageHelper, _sidebarService, modalDialog, _referrerservice) {
        ...
        this.dtclinicmappings = { PageSize: 20, MaxPageSize: 30 };
        this.dtclinicmapping = {};
        this.dtclinicmappingsFound = { PageSize: 20, MaxPageSize: 30 };
        ...
        if (!this.clinicForm.invalid && this.selectClinicName.ClinicName != undefined && this.selectClinicName.ClinicName != null && this.selectClinicName.ClinicName != '') {
            ...
            if (mappingexist != undefined && mappingexist != null && mappingexist.length > 0) {
                ...
                if (itemfound != undefined && itemfound != null && itemfound.length > 0) {
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Clinic Mapping", "Do you want to Update the Mapping. Please confirm", 1, false, 1, "400px")
                        .subscribe(res => {
                        if (res) {
                            this._referrerservice.SaveClinicMapping(this.dtclinicmappingsselect).subscribe(response => {
                                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Details processed successfully.", 0, false, 1, "500px", 0);
                                this.getClincmappings();
                                this.clearControls();
                            });
                        }
    ...
    getClincs() {
        ...
        this._referrerservice.getClinics().subscribe(res => {
            this.options = res;
            this.filteredOptions = this.myControl.valueChanges
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])(value => typeof value === 'string' ? value : value.name), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])(name => name ? this._filter(name) : this.options.slice()));
        }, err => { });
    }
    getClincmappings() {
        this.loadingData = true;
        this._referrerservice.getClinicMappings().subscribe(res => {
            this.dtclinicmappings.clinicmappings = res;
            ...
            this.angularDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.dtclinicmappings.clinicmappings.slice(0, this.dtclinicmappings.PageSize));
            ...
            this.dtclinicmappingsFound.clinicmappings = res;
            ...
            this.angularDataSourcefound = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.dtclinicmappingsFound.clinicmappings.slice(0, this.dtclinicmappingsFound.PageSize));
    ...
    getPaginationfoundData(pageEvent) {
        if (pageEvent.pageIndex != pageEvent.previousPageIndex) {
            //this.figDetail_Param.TNumber = this.loggedInUserDetails.TNumber;
    ...
    CreatePatient(patientid) {
        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Create Patient", "This action will Create Patient. Please confirm", 1, false, 1, "400px")
            .subscribe(res => {
            if (res) {
                this.loadingData = true;
                this._referrerservice.CreatePatient(patientid).subscribe(response => {
                    this.loadingData = false;
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Details Created successfully.", 0, false, 1, "500px", 0);
    ...
    RejectPatient(patientid) {
        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Reject Patient", "This action will Reject Patient. Please confirm", 1, false, 1, "400px")
            .subscribe(res => {
            if (res) {
                this.loadingData = true;
                this._referrerservice.RejectPatient(patientid).subscribe(response => {
                    this.loadingData = false;
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Details Rejected successfully.", 0, false, 1, "500px", 0);
                    // this.getInProgressPatients();
                });
            }
        });
    ...
    ImportPatient(patientid) {
        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Import Patient", "This action will Import Patient. Please confirm", 1, false, 1, "400px")
            .subscribe(res => {
            if (res) {
                this.loadingData = true;
                this._referrerservice.ImportPatient(patientid).subscribe(response => {
                    this.loadingData = false;
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Details Imported successfully.", 0, false, 1, "500px", 0);
                    // this.getInProgressPatients();
                });
            }
        });
    ...
    RemoveMapping(clinicno) {
        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Remove Mapping", "Do you want to remove mapping. Please confirm", 1, false, 1, "400px")
            .subscribe(res => {
            if (res) {
                this._referrerservice.RemoveMapping(clinicno).subscribe(response => {
                    this.loadingData = false;
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Mapping removed successfully.", 0, false, 1, "500px", 0);
                    this.getClincmappings();
                }, err => {
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "something went wrong", 0, false, 1, "500px", 1);
                });
            }
        });
    }
    EditMapping(clinicno) {
...
DtClinicUserMappingComponent.ctorParameters = () => [
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], DtClinicUserMappingComponent.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
...
], DtClinicUserMappingComponent.prototype, "sort", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("clinicForm", null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgForm"])
], DtClinicUserMappingComponent.prototype, "clinicForm", void 0);
DtClinicUserMappingComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dt-clinic-user-mapping',
        template: __importDefault(__webpack_require__(/*! raw-loader!./dt-clinic-user-mapping.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dt-clinic-user-mapping/dt-clinic-user-mapping.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./dt-clinic-user-mapping.component.scss */ "./src/app/modules/emrpage/component/dt-clinic-user-mapping/dt-clinic-user-mapping.component.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DtPatientReferralProcessedComponent", function() { return DtPatientReferralProcessedComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/layout/services/application-header.service */ "./src/app/layout/services/application-header.service.ts");
/* harmony import */ var src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/storage-helper.service */ "./src/app/core/services/storage-helper.service.ts");
...
let DtPatientReferralProcessedComponent = class DtPatientReferralProcessedComponent {
    constructor(_headerService, _storageHelper, _navigate, _sidebarService, modalDialog, _referrerservice) {
        this._headerService = _headerService;
        this._storageHelper = _storageHelper;
        ...
        this.dtprocessedPatients = { PageSize: 20, MaxPageSize: 30 };
    ...
    unprocessReferral(ID) {
        this.loadingData = true;
        this._referrerservice.unprocessReferral(ID).subscribe(res => {
            this.loadingData = false;
            if (res == true) {
                // this.noRecordsMessage1 = "Message moved to Inbox Succcessfully";
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Message moved to Inbox Succcessfully.", 0, false, 1, "500px", 0);
                this.getProcessedPatients();
            }
            else {
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Failed to move Message to Inbox.", 0, false, 1, "500px", 1);
    ...
    getProcessedPatients() {
        this.loadingData = true;
        this._referrerservice.getDTProcessedtMessageList(this.loggedInUserDetails.LoginName).subscribe(res => {
            this.loadingData = false;
            this.dtprocessedPatients.processeddtmessages = res;
            ...
            this.angularDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.dtprocessedPatients.processeddtmessages.slice(0, this.dtprocessedPatients.PageSize));
            this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_11__["SelectionModel"](false, []);
...
DtPatientReferralProcessedComponent.ctorParameters = () => [
    { type: src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"] },
    { type: src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"] },
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], DtPatientReferralProcessedComponent.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], DtPatientReferralProcessedComponent.prototype, "sort", void 0);
DtPatientReferralProcessedComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dt-patient-referral-processed',
        template: __importDefault(__webpack_require__(/*! raw-loader!./dt-patient-referral-processed.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dt-patient-referral-processed/dt-patient-referral-processed.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./dt-patient-referral-processed.component.scss */ "./src/app/modules/emrpage/component/dt-patient-referral-processed/dt-patient-referral-processed.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"], src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"], _angular_router__WEBPACK_IMPORTED_MODULE_10__["Router"],
        src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_9__["ReferralService"]])
], DtPatientReferralProcessedComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DtPatientReferralWIPComponent", function() { return DtPatientReferralWIPComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/layout/services/application-header.service */ "./src/app/layout/services/application-header.service.ts");
/* harmony import */ var src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/storage-helper.service */ "./src/app/core/services/storage-helper.service.ts");
...
let DtPatientReferralWIPComponent = class DtPatientReferralWIPComponent {
    constructor(_headerService, _storageHelper, _sidebarService, modalDialog, _referrerservice) {
        this._headerService = _headerService;
        this._storageHelper = _storageHelper;
        this._sidebarService = _sidebarService;
        ...
        this.dtwipPatients = { PageSize: 20, MaxPageSize: 30 };
        this.dtwipPatient = {};
        this.dtwipPatientsFound = { PageSize: 20, MaxPageSize: 30 };
    ...
    getInProgressPatients() {
        this.loadingData = true;
        this._referrerservice.getInProgressPatients().subscribe(res => {
            this.dtwipPatients.wipdtmessages = res;
            ...
            this.angularDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.dtwipPatients.wipdtmessages.slice(0, this.dtwipPatients.PageSize));
            ...
            this.dtwipPatientsFound.wipdtmessages = res;
            ...
            this.angularDataSourcefound = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.dtwipPatientsFound.wipdtmessages.filter(x => x.MatchFound == true).slice(0, this.dtwipPatients.PageSize));
            console.log(this.angularDataSourcefound.data.length);
...
DtPatientReferralWIPComponent.ctorParameters = () => [
    { type: src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"] },
    { type: src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"] },
    { type: src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], DtPatientReferralWIPComponent.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], DtPatientReferralWIPComponent.prototype, "sort", void 0);
DtPatientReferralWIPComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dt-patient-referral-wip',
        template: __importDefault(__webpack_require__(/*! raw-loader!./dt-patient-referral-wip.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dt-patient-referral-wip/dt-patient-referral-wip.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./dt-patient-referral-wip.component.scss */ "./src/app/modules/emrpage/component/dt-patient-referral-wip/dt-patient-referral-wip.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"], src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"], src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_9__["ReferralService"]])
], DtPatientReferralWIPComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DtPlanCareProcessedComponent", function() { return DtPlanCareProcessedComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/layout/services/application-header.service */ "./src/app/layout/services/application-header.service.ts");
/* harmony import */ var src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/storage-helper.service */ "./src/app/core/services/storage-helper.service.ts");
...
/* harmony import */ var _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/material/sort */ "./node_modules/@angular/material/esm2015/sort.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/modules/emrpage/services/referral.service */ "./src/app/modules/emrpage/services/referral.service.ts");
...
let DtPlanCareProcessedComponent = class DtPlanCareProcessedComponent {
    constructor(_headerService, _storageHelper, _navigate, _sidebarService, modalDialog, _referrerservice) {
        this._headerService = _headerService;
        this._storageHelper = _storageHelper;
        this._navigate = _navigate;
        ...
        this.displayedColumns1 = ['FirstName', 'LastName', 'City', 'State', 'DOB', 'ReceptionistComments'];
        this.dtprocessedPocs = { PageSize: 20, MaxPageSize: 30 };
        this.dtprocessedPoc = {};
        this.processedPOCsList = {};
        this.dtdeclinedPocs = { PageSize: 20, MaxPageSize: 30 };
        this.dtdeclinedPoc = {};
    ...
    getPOCS() {
        this.loadingData = true;
        debugger;
        this._referrerservice.getPocs(this.loggedInUserDetails.LoginName).subscribe(res => {
            this.processedPOCsList = res;
            ...
            if (this.dtprocessedPocs.processeddtmessages != null && this.dtprocessedPocs.processeddtmessages.length > 0 && this.dtprocessedPocs.processeddtmessages != undefined) {
                ...
                this.angularDataSourceProcessed = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.dtprocessedPocs.processeddtmessages.slice(0, this.dtprocessedPocs.PageSize));
                this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_10__["SelectionModel"](false, []);
            ...
            if (this.dtdeclinedPocs.processeddtmessages != null && this.dtdeclinedPocs.processeddtmessages.length > 0 && this.dtdeclinedPocs.processeddtmessages != undefined) {
                ...
                this.angularDataSourceDeclined = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.dtdeclinedPocs.processeddtmessages.slice(0, this.dtprocessedPocs.PageSize));
                this.declinedselection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_10__["SelectionModel"](false, []);
                //console.log(this.angularDataSourcefound.data.length);
    ...
    getPaginationDataProcessed(pageEvent) {
        if (pageEvent.pageIndex != pageEvent.previousPageIndex) {
            //this.figDetail_Param.TNumber = this.loggedInUserDetails.TNumber;
    ...
    getPaginationDataDeclined(pageEvent) {
        if (pageEvent.pageIndex != pageEvent.previousPageIndex) {
            //this.figDetail_Param.TNumber = this.loggedInUserDetails.TNumber;
...
DtPlanCareProcessedComponent.ctorParameters = () => [
    { type: src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"] },
    { type: src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"] },
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], DtPlanCareProcessedComponent.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], DtPlanCareProcessedComponent.prototype, "sort", void 0);
DtPlanCareProcessedComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dt-plan-care-processed',
        template: __importDefault(__webpack_require__(/*! raw-loader!./dt-plan-care-processed.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dt-plan-care-processed/dt-plan-care-processed.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./dt-plan-care-processed.component.scss */ "./src/app/modules/emrpage/component/dt-plan-care-processed/dt-plan-care-processed.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"], src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"], _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"],
        src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_8__["ReferralService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DtSentPocComponent", function() { return DtSentPocComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/layout/services/application-header.service */ "./src/app/layout/services/application-header.service.ts");
/* harmony import */ var src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/storage-helper.service */ "./src/app/core/services/storage-helper.service.ts");
...
let DtSentPocComponent = class DtSentPocComponent {
    constructor(_headerService, _storageHelper, _navigate, _sidebarService, modalDialog, _referrerservice) {
        this._headerService = _headerService;
        this._storageHelper = _storageHelper;
        this._navigate = _navigate;
        ...
        this.dtSentPocs = { PageSize: 20, MaxPageSize: 30 };
    ...
    getSentPocs() {
        this.loadingData = true;
        this._referrerservice.getSentPOCList(this.loggedInUserDetails.LoginName).subscribe(res => {
            debugger;
            this.loadingData = false;
            this.dtSentPocs.sentPocs = res;
            //this.dtprocessedPatients.processeddtmessages = this.dtprocessedPatients.processeddtmessages.filter(x => x.MatchFound == false);
            ...
            this.angularDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.dtSentPocs.sentPocs.slice(0, this.dtSentPocs.PageSize));
            this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_10__["SelectionModel"](false, []);
...
DtSentPocComponent.ctorParameters = () => [
    { type: src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"] },
    { type: src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"] },
    { type: src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"] },
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], DtSentPocComponent.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], DtSentPocComponent.prototype, "sort", void 0);
DtSentPocComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dt-sent-poc',
        template: __importDefault(__webpack_require__(/*! raw-loader!./dt-sent-poc.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dt-sent-poc/dt-sent-poc.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./dt-sent-poc.component.scss */ "./src/app/modules/emrpage/component/dt-sent-poc/dt-sent-poc.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"], src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"], _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"],
        src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_8__["ReferralService"]])
], DtSentPocComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DTIncomingMessageDetailComponent", function() { return DTIncomingMessageDetailComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "XMLViewDialog", function() { return XMLViewDialog; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PatientDialog", function() { return PatientDialog; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReferrerDialog", function() { return ReferrerDialog; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/layout/services/application-header.service */ "./src/app/layout/services/application-header.service.ts");
/* harmony import */ var src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/storage-helper.service */ "./src/app/core/services/storage-helper.service.ts");
...
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../shared/components/modal/ModalStaticClass */ "./src/app/modules/shared/components/modal/ModalStaticClass.ts");
/* harmony import */ var src_app_modules_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/modules/shared/services/shared.service */ "./src/app/modules/shared/services/shared.service.ts");
/* harmony import */ var src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/modules/emrpage/services/referral.service */ "./src/app/modules/emrpage/services/referral.service.ts");
...
/* harmony import */ var angular_archwizard__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! angular-archwizard */ "./node_modules/angular-archwizard/fesm2015/angular-archwizard.js");
...
/* harmony import */ var rxjs_add_operator_pairwise__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! rxjs/add/operator/pairwise */ "./node_modules/rxjs-compat/_esm2015/add/operator/pairwise.js");
...
let DTIncomingMessageDetailComponent = class DTIncomingMessageDetailComponent {
    constructor(_headerService, _storageHelper, _sidebarService, modalDialog, _referrerservice, _router, _navigate, datepipe) {
        this._headerService = _headerService;
        this._storageHelper = _storageHelper;
        this._sidebarService = _sidebarService;
        this.modalDialog = modalDialog;
        ...
        this.DTIncomingXML = { PageSize: 5, MaxPageSize: 30 };
        ...
        this.DTPatients = { PageSize: 5, MaxPageSize: 30 };
        this.DTincomingmessageResponse = {};
        this.DTPOCs = { PageSize: 5, MaxPageSize: 30 };
        ...
        this.referrerlist = { PageSize: 5, MaxPageSize: 7 };
        ...
        this.pocdisplayedColumns = ['Option', 'ApprovalSent', 'TherapistName', 'PDFName'];
        ...
        this.pocselection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_12__["SelectionModel"](false, []);
    ...
    getIncomingMessageDetail() {
        ...
        this._router.params.subscribe(params => {
            ...
            if (this.requestedAction == "referralprocessed") {
                this._referrerservice.getIncomingMessageOperation(this.InComingMessageId, 'referralprocessed').subscribe(res => {
                    console.log("response" + res);
                    if (res == "404 : Incoming message does not have attachment") {
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Incoming message does not have attachment", 0, false, 1, "500px", 1);
                        this.redirectMainPage();
                    }
                    else {
                        this._referrerservice.UpdateMessageReadFlag(this.InComingMessageId).subscribe(response => {
                            console.log('IsReadFlag Updated');
                        }, err => { });
                        this.DTincomingmessagedetail = res;
                        ...
                        this.DTIncomingXML.XMLattachment = this.DTincomingmessagedetail.XMLattachment;
                        ...
                        this.angularDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.DTIncomingXML.XMLattachment.slice(0, this.DTIncomingXML.PageSize));
                        this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_12__["SelectionModel"](false, []);
            ...
            if (this.requestedAction == "pocprocessed") {
                this._referrerservice.getIncomingMessageOperation(this.InComingMessageId, 'pocprocessed').subscribe(res => {
                    console.log("response" + res);
                    if (res == "404 : Incoming message does not have attachment") {
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Incoming message does not have attachment", 0, false, 1, "500px", 1);
                        this.redirectMainPage();
            ...
            if (this.requestedAction == "declinedprocessed") {
                this._referrerservice.getIncomingMessageOperation(this.InComingMessageId, 'declinedprocessed').subscribe(res => {
                    console.log("response" + res);
                    if (res == "404 : Incoming message does not have attachment") {
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Incoming message does not have attachment", 0, false, 1, "500px", 1);
                        this.redirectMainPage();
                ...
                this._referrerservice.getIncomingMessageOperation(this.InComingMessageId, 'sentforapproval').subscribe(res => {
                    console.log("response" + res);
                    if (res == "404 : Incoming message does not have attachment") {
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Incoming message does not have attachment", 0, false, 1, "500px", 1);
                        this.redirectMainPage();
                ...
                this._referrerservice.getIncomingMessageOperation(this.InComingMessageId, 'Edit').subscribe(res => {
                    console.log("response" + res);
                    if (res == "404 : Incoming message does not have attachment") {
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Incoming message does not have attachment", 0, false, 1, "500px", 1);
                        this.redirectMainPage();
    ...
    acceptDetails() {
        ...
        this._referrerservice.AcceptPatient(this.acceptpatient).subscribe(response => {
            this.loadingData = false;
            _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Details processed successfully.", 0, false, 1, "500px", 0);
        }, err => {
            this.loadingData = false;
            _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Unable to accept / Reject patient, please contact administrator.", 0, false, 1, "500px", 1);
        });
    }
    rejectDetails() {
        this.loadingData = true;
        ...
        this.acceptpatient.AttachmentID = this.DTincomingmessagedetailprocessed.AttachmentID;
        this._referrerservice.RejectPatient(this.rejectpatient).subscribe(res => {
            this.loadingData = false;
            //ModalStaticClass.show(this.modalDialog, "", "Success", "Details processed successfully.", 0, false, 1, "500px", 0);
            var response = res;
            if (response.ErrorCode == "200") {
                this.loadingData = false;
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", response.ErrorCode + " : " + response.ErrorMessage, 0, false, 1, "500px", 0);
                this.redirectMainPage();
            }
            else {
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "502 : Patient reject could not be processed sucessfully. Please contact IT support.", 0, false, 1, "500px", 0);
                this.redirectMainPage();
            }
        }, err => {
            this.loadingData = false;
    ...
    createDetails() {
        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Confirm", "Are you sure, this could create a duplicate patient?", 2, false, 0, "500px", 3)
            .subscribe(res => {
            if (res.result == 'yes') {
                this.loadingData = true;
                debugger;
                ...
                this.acceptpatient.InUserID = this.loggedInUserDetails.LoginName;
                this.acceptpatient.AttachmentID = this.DTincomingmessagedetailprocessed.AttachmentID;
                this._referrerservice.GetRehabReferrerList(this.acceptpatient).subscribe(response => {
                    this.loadingData = false;
                    this.responsereferrerlist = response;
                    if (this.responsereferrerlist != null) {
                        this.referrerlist.rehabReferrers = this.responsereferrerlist;
                        ...
                        this.referrerDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.referrerlist.rehabReferrers.slice(0, this.referrerlist.PageSize));
                        ...
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "No referrer Data exists", 0, false, 1, "500px", 1);
                    }
                }, err => {
                    this.loadingData = false;
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Unable to accept / Reject patient, please contact administrator.", 0, false, 1, "500px", 1);
    ...
    importDetails(patientId) {
        ...
        this.acceptpatient.InUserID = this.loggedInUserDetails.LoginName;
        this.acceptpatient.AttachmentID = this.DTincomingmessagedetailprocessed.AttachmentID;
        this._referrerservice.ImportPatient(this.acceptpatient).subscribe(res => {
            var response = res;
            if (response.ErrorCode == "200") {
                this.loadingData = false;
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", response.ErrorCode + " : " + response.ErrorMessage, 0, false, 1, "500px", 0);
                ...
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "502 : Patient importing could not be processed sucessfully. Please contact IT support.", 0, false, 1, "500px", 0);
                this.redirectMainPage();
            }
        }, err => {
            this.loadingData = false;
            _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Unable to accept / Reject / import, please contact administrator.", 0, false, 1, "500px", 1);
        });
    }
    processPOC() {
        ...
        if (this.DTPOC.Docrowid != null &&
            ...
            this.loadingData = true;
            this._referrerservice.ProcessPOC(this.DTPatient.Prowid, this.DTincomingmessageResponse.Operation, this.DTincomingmessagedetail.ID, this.DTPOC.Docrowid, this.DTPOC.PDFName, this.loggedInUserDetails.LoginName, this.DTincomingmessagedetailprocessed.AttachmentID).subscribe(res => {
                this.loadingData = false;
                var response = res;
                if (response.ErrorCode == "200") {
                    this.loadingData = false;
                    ...
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "502 : Plan of Care Approval could not be processed successfully. Please contact IT support.", 0, false, 1, "500px", 0);
                    this.redirectMainPage();
                }
            }, err => {
                this.loadingData = false;
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "something went wrong", 0, false, 1, "500px", 0);
            });
        }
        else {
    ...
    getPDF(event) {
        ...
        this.loadingData = true;
        this._referrerservice.DownloadPOCFile(event.Docrowid).subscribe(res => {
            var contentType = res.headers.get('content-type');
            var blob = new Blob([res.body], { type: contentType });
            Object(file_saver__WEBPACK_IMPORTED_MODULE_15__["saveAs"])(blob, 'sample.pdf');
            ...
            this.loadingData = false;
            _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "There was an error while downloading the report.", 0, false, 1, "500px");
        });
    }
    getPOCDetails() {
        this.loadingData = true;
        ...
        if (this.DTPatient.Prowid != null &&
            ...
            if (this.DTincomingmessageResponse.Operation == 'Referral') {
                this._referrerservice.getPOCList(this.DTPatient.Prowid, this.DTincomingmessageResponse.Operation).subscribe(response => {
                    this.loadingData = false;
                    this.DTincomingmessageResponse = response;
                    if (this.DTincomingmessageResponse.DT_POCs != null && this.DTincomingmessageResponse.DT_POCs.length > 0) {
                        this.DTPOCs.IncomingMessagePOCs = this.DTincomingmessageResponse.DT_POCs;
                        ...
                        this.pocDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.DTPOCs.IncomingMessagePOCs.slice(0, this.DTPOCs.PageSize));
                        this.pocselection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_12__["SelectionModel"](false, []);
                        ...
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Confirmation", "Please Accept OR Reject Patient", 0, false, 1, "500px", 3);
                    }
                }, err => {
                    this.loadingData = false;
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "something went wrong", 0, false, 1, "500px", 1);
                ...
                this._referrerservice.getPOCList(this.DTPatient.Prowid, this.DTincomingmessageResponse.Operation).subscribe(response => {
                    ...
                    if (this.DTincomingmessageResponse.DT_POCs != null && this.DTincomingmessageResponse.DT_POCs.length > 0) {
                        ...
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "No POC Exist for Patient", 0, false, 1, "500px", 1);
                    }
                }, err => {
                    this.loadingData = false;
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "something went wrong", 0, false, 1, "500px", 1);
    ...
    saveDetails() {
        ...
        if (this.mainscreenfrom.valid && this.DTincomingmessagedetailprocessed.FileName != undefined &&
            ...
            this._referrerservice.processIncomingMesssage(this.DTincomingmessagedetailprocessed).subscribe(response => {
                this.loadingData = false;
                //ModalStaticClass.show(this.modalDialog, "", "Success", "Details processed successfully.", 0, false, 1, "500px", 0);
                this.DTincomingmessageResponse = response;
                ...
                if (this.DTincomingmessageResponse.Operation == 'Referral') {
                    if (this.DTincomingmessageResponse.DT_Patients != null && this.DTincomingmessageResponse.DT_Patients.length > 0) {
                        ...
                        //this.wizard.goToNextStep();
                        this.DTPatients.IncomingMessagePatients = this.DTincomingmessageResponse.DT_Patients;
                        ...
                        this.patientDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.DTPatients.IncomingMessagePatients.slice(0, this.DTPatients.PageSize));
                        this.patientselection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_12__["SelectionModel"](false, []);
                    ...
                    if (this.DTincomingmessageResponse.DT_Patients != null && this.DTincomingmessageResponse.DT_Patients.length > 0 && this.DTincomingmessageResponse.DT_Patients[0].FirstName != null && this.DTincomingmessageResponse.DT_Patients[0].FirstName != "") {
                        ...
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "200 : Plan of care Approval Processed Successfully. Patient MRN is " + this.DTincomingmessageResponse.DT_Patients[0].MRNNumber, 0, false, 1, "500px", 1);
                        this.redirectMainPage();
                        // WHEN outgoingmessage id is not present but patient id and note id present.
                    }
                    else {
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "404 : Patient not found", 0, false, 1, "500px", 1);
                        this.redirectMainPage();
                    }
                    this.FinishTitle = "3";
                }
    ...
    getPatientPaginationData(pageEvent) {
        if (pageEvent.pageIndex != pageEvent.previousPageIndex) {
            //this.figDetail_Param.TNumber = this.loggedInUserDetails.TNumber;
    ...
    getPOCPaginationData(pageEvent) {
        if (pageEvent.pageIndex != pageEvent.previousPageIndex) {
            //this.figDetail_Param.TNumber = this.loggedInUserDetails.TNumber;
...
DTIncomingMessageDetailComponent.ctorParameters = () => [
    { type: src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"] },
    { type: src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"] },
    { type: src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], DTIncomingMessageDetailComponent.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], DTIncomingMessageDetailComponent.prototype, "sort", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(angular_archwizard__WEBPACK_IMPORTED_MODULE_13__["WizardComponent"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", angular_archwizard__WEBPACK_IMPORTED_MODULE_13__["WizardComponent"])
], DTIncomingMessageDetailComponent.prototype, "wizard", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("mainscreenfrom", null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_16__["NgForm"])
], DTIncomingMessageDetailComponent.prototype, "mainscreenfrom", void 0);
DTIncomingMessageDetailComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dtincoming-message-detail',
        template: __importDefault(__webpack_require__(/*! raw-loader!./dtincoming-message-detail.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dtincoming-message-detail/dtincoming-message-detail.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./dtincoming-message-detail.component.scss */ "./src/app/modules/emrpage/component/dtincoming-message-detail/dtincoming-message-detail.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"], src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"], src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_10__["ReferralService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_11__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_11__["Router"],
        _angular_common__WEBPACK_IMPORTED_MODULE_14__["DatePipe"]])
], DTIncomingMessageDetailComponent);

let XMLViewDialog = class XMLViewDialog {
    constructor(dialogRef, _referrerservice, modalDialog, _sharedService, data) {
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], XMLViewDialog.prototype, "personalizeSort", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("alloDataForm", null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_16__["NgForm"])
], XMLViewDialog.prototype, "alloDataForm", void 0);
XMLViewDialog = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'xml-dialog',
        template: __importDefault(__webpack_require__(/*! raw-loader!./admin-dialog.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dtincoming-message-detail/admin-dialog.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./dtincoming-message-detail.component.scss */ "./src/app/modules/emrpage/component/dtincoming-message-detail/dtincoming-message-detail.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(4, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MAT_DIALOG_DATA"])),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialogRef"],
        src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_10__["ReferralService"],
        _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_modules_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_9__["SharedService"], Object])
], XMLViewDialog);

let PatientDialog = class PatientDialog {
    constructor(dialogRef, _referrerservice, _navigate, modalDialog, _sharedService, data) {
        this.dialogRef = dialogRef;
        this._referrerservice = _referrerservice;
        this._navigate = _navigate;
        this.modalDialog = modalDialog;
        ...
        this.DTPatients = { PageSize: 20, MaxPageSize: 30 };
        this.DTincomingmessageResponse = {};
        this.patientDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.DTPatients.IncomingMessagePatients);
        this.patientselection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_12__["SelectionModel"](false, []);
        this.pageSizeOptions = [5, 10, 20, 30];
    ...
    acceptDetails() {
        ...
        //    });
        this._referrerservice.GetRehabReferrerList(this.patientselectedDetails).subscribe(response => {
            this.loadingData = false;
            this.responsereferrerlist = response;
            if (this.responsereferrerlist != null) {
                this.referrerlist.rehabReferrers = this.responsereferrerlist;
    ...
    rejectDetails() {
        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Confirm", "Are you sure?", 2, false, 0, "500px", 3)
            .subscribe(res => {
            if (res.result == 'yes') {
                this.loadingData = true;
                this._referrerservice.RejectPatient(this.patientselectedDetails).subscribe(res => {
                    this.loadingData = false;
                    this.closeDialog();
                    var response = res;
                    if (response.ErrorCode == "200") {
                        ...
                        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "502 :  Patient rejection could not be processed sucessfully. Please contact IT support.", 0, false, 1, "500px", 0);
                    }
                }, err => {
                    this.loadingData = false;
                    this.closeDialog();
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], PatientDialog.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], PatientDialog.prototype, "sort", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], { static: true }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], PatientDialog.prototype, "personalizeSort", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("alloDataForm", null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_16__["NgForm"])
], PatientDialog.prototype, "alloDataForm", void 0);
PatientDialog = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'patient-dialog',
        template: __importDefault(__webpack_require__(/*! raw-loader!./patient-dialog.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dtincoming-message-detail/patient-dialog.component.html")).default,
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(5, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MAT_DIALOG_DATA"])),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialogRef"],
        src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_10__["ReferralService"], _angular_router__WEBPACK_IMPORTED_MODULE_11__["Router"],
        _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_modules_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_9__["SharedService"], Object])
], PatientDialog);

/*This is Referrer List*/
let ReferrerDialog = class ReferrerDialog {
    constructor(dialogRef, _referrerservice, _navigate, modalDialog, _sharedService, data) {
        this.dialogRef = dialogRef;
        this._referrerservice = _referrerservice;
        this._navigate = _navigate;
        ...
        this.referrerlist = { PageSize: 5, MaxPageSize: 5 };
        this.referrerDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.referrerlist.rehabReferrers);
    ...
    acceptDetails(eventID) {
        ...
        if (this.patient.ReferrerID != undefined && this.patient.ReferrerID != null) {
            this._referrerservice.CreatePatient(this.patient).subscribe(res => {
                this.closeDialog();
                this.loadingData = false;
                var response = res;
                if (response.ErrorCode == "200") {
                    ...
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", response.ErrorCode + " : " + response.ErrorMessage, 0, false, 1, "500px", 0);
                    // this.redirectMainPage();
                }
                else {
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "502 : Patient referral could not be processed sucessfully. Please contact IT support.", 0, false, 1, "500px", 0);
                }
            }, err => {
                this.loadingData = false;
                this.closeDialog();
    ...
    getReferrerPaginationData(pageEvent) {
        if (pageEvent.pageIndex != pageEvent.previousPageIndex) {
            //this.figDetail_Param.TNumber = this.loggedInUserDetails.TNumber;
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], ReferrerDialog.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], ReferrerDialog.prototype, "sort", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], { static: true }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], ReferrerDialog.prototype, "personalizeSort", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("alloDataForm", null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_16__["NgForm"])
], ReferrerDialog.prototype, "alloDataForm", void 0);
ReferrerDialog = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'referrer-dialog',
        template: __importDefault(__webpack_require__(/*! raw-loader!./referrer-dialog.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dtincoming-message-detail/referrer-dialog.component.html")).default,
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(5, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MAT_DIALOG_DATA"])),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialogRef"],
        src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_10__["ReferralService"], _angular_router__WEBPACK_IMPORTED_MODULE_11__["Router"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DTPocNotFoundComponent", function() { return DTPocNotFoundComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/layout/services/application-header.service */ "./src/app/layout/services/application-header.service.ts");
/* harmony import */ var src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/storage-helper.service */ "./src/app/core/services/storage-helper.service.ts");
...
let DTPocNotFoundComponent = class DTPocNotFoundComponent {
    constructor(_headerService, _storageHelper, _sidebarService, modalDialog, _referrerservice) {
        this._headerService = _headerService;
        this._storageHelper = _storageHelper;
        this._sidebarService = _sidebarService;
        ...
        this.DTPOCNotFoundMessages = { PageSize: 20, MaxPageSize: 30 };
    ...
    getDTPOCNotFoundMessageList() {
        this.loadingData = true;
        this._referrerservice.getDTPOCNotFoundMessageList().subscribe(res => {
            this.DTPOCNotFoundMessages.IdtpocnotfoundMessages = res;
            this.loadingData = false;
            ...
            this.angularDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.DTPOCNotFoundMessages.IdtpocnotfoundMessages.slice(0, this.DTPOCNotFoundMessages.PageSize));
...
DTPocNotFoundComponent.ctorParameters = () => [
    { type: src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"] },
    { type: src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"] },
    { type: src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], DTPocNotFoundComponent.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], DTPocNotFoundComponent.prototype, "sort", void 0);
DTPocNotFoundComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dtpoc-not-found',
        template: __importDefault(__webpack_require__(/*! raw-loader!./dtpoc-not-found.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/dtpoc-not-found/dtpoc-not-found.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./dtpoc-not-found.component.scss */ "./src/app/modules/emrpage/component/dtpoc-not-found/dtpoc-not-found.component.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EMRaddviewComponent", function() { return EMRaddviewComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PersonalizationDialog", function() { return PersonalizationDialog; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/layout/services/application-header.service */ "./src/app/layout/services/application-header.service.ts");
/* harmony import */ var src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/storage-helper.service */ "./src/app/core/services/storage-helper.service.ts");
...
let EMRaddviewComponent = class EMRaddviewComponent {
    constructor(_headerService, _storageHelper, _sidebarService, modalDialog, _referrerservice) {
        this._headerService = _headerService;
        this._storageHelper = _storageHelper;
        this._sidebarService = _sidebarService;
        ...
        this.DTReferrers = { PageSize: 20, MaxPageSize: 30 };
        this.referrerDetail = {};
    ...
    getReferrerList() {
        this.loadingData = true;
        this._referrerservice.getReferrerList().subscribe(res => {
            this.DTReferrers.DirectTrustReferrers = res;
            this.loadingData = false;
            ...
            this.angularDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.DTReferrers.DirectTrustReferrers.slice(0, this.DTReferrers.PageSize));
    ...
    getReferrerDetail(instituteid) {
        //this.loadingData = true;
        this._referrerservice.getReferrerDetail(instituteid).subscribe(response => {
    ...
    deleteDetails(instituteid, RefEmailID) {
        this.referrerDetaildelete.RefEmailID = RefEmailID;
        this.referrerDetaildelete.RefID = instituteid;
        _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Delete Referrer", "This action will Delete Referrer. Please confirm", 1, false, 1, "400px")
            .subscribe(res => {
            if (res) {
                this.loadingData = true;
                this._referrerservice.deleteReferrerDetails(this.referrerDetaildelete).subscribe(response => {
                    this.loadingData = false;
                    _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Details Deleted successfully.", 0, false, 1, "500px", 0);
                    this.getReferrerList();
                });
            }
        });
...
EMRaddviewComponent.ctorParameters = () => [
    { type: src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"] },
    { type: src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"] },
    { type: src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], EMRaddviewComponent.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], EMRaddviewComponent.prototype, "sort", void 0);
EMRaddviewComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-emraddview',
        template: __importDefault(__webpack_require__(/*! raw-loader!./emraddview.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/emraddview/emraddview.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./emraddview.component.scss */ "./src/app/modules/emrpage/component/emraddview/emraddview.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"], src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"], src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_10__["ReferralService"]])
], EMRaddviewComponent);

let PersonalizationDialog = class PersonalizationDialog {
    constructor(dialogRef, _referrerservice, modalDialog, _sharedService, data) {
        this.dialogRef = dialogRef;
        this._referrerservice = _referrerservice;
        this.modalDialog = modalDialog;
    ...
    saveDetails() {
        ...
        if (this.alloDataForm.valid) {
            this._referrerservice.saveReferrerDetails(this.defaultValues).subscribe(response => {
                this.loadingData = false;
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Details saved successfully.", 0, false, 1, "500px", 0);
                this.dialogRef.close();
                this.getReferrerList();
            });
        }
    ...
    updateDetails() {
        if (this.alloDataForm.valid) {
            this.loadingData = true;
            // var detailsToBeSent: IPersonalization = { TNumber: this.data.personalizationDetails.TNumber, PersonalizationDetails: this.dataSource.data }
            this._referrerservice.updateReferrerDetails(this.defaultValues).subscribe(response => {
                this.loadingData = false;
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Details saved successfully.", 0, false, 1, "500px", 0);
                this.dialogRef.close();
                this.getReferrerList();
...
PersonalizationDialog.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialogRef"] },
    { type: src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_10__["ReferralService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
    { type: src_app_modules_shared_services_shared_service__WEBPACK_IMPORTED_MODULE_9__["SharedService"] },
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], { static: true }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], PersonalizationDialog.prototype, "personalizeSort", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("alloDataForm", null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgForm"])
], PersonalizationDialog.prototype, "alloDataForm", void 0);
PersonalizationDialog = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'referrer-dialog',
        template: __importDefault(__webpack_require__(/*! raw-loader!./admin-dialog.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/emraddview/admin-dialog.component.html")).default,
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(4, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MAT_DIALOG_DATA"])),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialogRef"],
        src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_10__["ReferralService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IncomingmessageComponent", function() { return IncomingmessageComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/layout/services/application-header.service */ "./src/app/layout/services/application-header.service.ts");
/* harmony import */ var src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/core/services/storage-helper.service */ "./src/app/core/services/storage-helper.service.ts");
...
/* harmony import */ var _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @angular/cdk/keycodes */ "./node_modules/@angular/cdk/esm2015/keycodes.js");
/* harmony import */ var ng2_file_upload__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ng2-file-upload */ "./node_modules/ng2-file-upload/fesm2015/ng2-file-upload.js");
...
let IncomingmessageComponent = class IncomingmessageComponent {
    constructor(_headerService, _storageHelper, _sidebarService, modalDialog, _referrerservice, _navigate, datepipe) {
        this._headerService = _headerService;
        this._storageHelper = _storageHelper;
        this._sidebarService = _sidebarService;
        this.modalDialog = modalDialog;
        ...
        this.DTincomingMessages = { PageSize: 20, MaxPageSize: 30 };
        this.DTdeletedincomingMessages = { PageSize: 20, MaxPageSize: 30 };
        ...
        this.ccallmails = [];
        this.isEdit = false;
        this.DTMessageSentList = { PageSize: 20, MaxPageSize: 30 };
        this.DTMessageSent = {};
        ...
        this.filteredmails = this.fruitCtrl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_15__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_15__["map"])((fruit) => fruit ? this._filter(fruit) : this.allmails.slice()));
        this.filteredccmails = this.ccCtrl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_15__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_15__["map"])((cc) => cc ? this._ccfilter(cc) : this.ccallmails.slice()));
    }
    ngOnInit() {
        var _a;
    ...
    getIncomingMessageList() {
        ...
        this._referrerservice.getIncomingMessageList(this.loggedInUserDetails.EmailId, this.loggedInUserDetails.Roles).subscribe(res => {
            this.DTincomingMessages.IncomingMessages = res;
            ...
            this.angularDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.DTincomingMessages.IncomingMessages.slice(0, this.DTincomingMessages.PageSize));
            this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_13__["SelectionModel"](false, []);
    ...
    getDeletedIncomingMessageList() {
        this.loadingData = true;
        console.log(this.loggedInUserDetails);
        this._referrerservice.getDeletedIncomingMessageList(this.loggedInUserDetails.EmailId, this.loggedInUserDetails.Roles).subscribe(res => {
            this.DTdeletedincomingMessages.IncomingMessages = res;
            ...
            this.deletedmessageangularDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.DTdeletedincomingMessages.IncomingMessages.slice(0, this.DTdeletedincomingMessages.PageSize));
            this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_13__["SelectionModel"](false, []);
    ...
    getSentMessageList() {
        this.loadingData = true;
        console.log(this.loggedInUserDetails);
        this._referrerservice.getUserEmailMessages(this.loggedInUserDetails.LoginName).subscribe(res => {
            this.DTMessageSentList.message = res;
            ...
            this.angularDataSourceSentMessage = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](this.DTMessageSentList.message.slice(0, this.DTMessageSentList.PageSize));
            this.sentselection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_13__["SelectionModel"](false, []);
    ...
    getUserEmails() {
        this.loadingData = true;
        console.log(this.loggedInUserDetails);
        this._referrerservice.getUserEmails().subscribe(res => {
            this.allmails = res;
            this.ccallmails = res;
            this.loadingData = false;
        }, err => { });
    ...
    sendEmail() {
        ...
        if (this.mails.length == 0) {
            ...
            this._referrerservice.sendEmailMessage(this.DTMessageSent).subscribe(response => {
                this.loadingData = false;
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Sent successfully.", 0, false, 1, "500px", 0);
                this.clearComposeEmail();
                this.getSentMessageList();
                this.openDiv("Inbox");
            }, err => {
                this.loadingData = false;
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Unable to sent, please contact administrator.", 0, false, 1, "500px", 1);
            });
        }
    }
    //Paginator
    ...
    getDeletedMessagePaginationData(pageEvent) {
        if (pageEvent.pageIndex != pageEvent.previousPageIndex) {
            //this.figDetail_Param.TNumber = this.loggedInUserDetails.TNumber;
    ...
    getPaginationDataSentMessage(pageEvent) {
        if (pageEvent.pageIndex != pageEvent.previousPageIndex) {
            //this.figDetail_Param.TNumber = this.loggedInUserDetails.TNumber;
    ...
    UpdateReadUnReadMessage(operation) {
        if (this.selectedMessageID.length > 0) {
            ...
            this.loadingData = true;
            this._referrerservice.UpdateReadUnReadMessage(this.checkedMessages).subscribe(response => {
                this.loadingData = false;
                console.log('IsReadFlag Updated');
                this.getIncomingMessageList();
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Message Flag updated successfully.", 0, false, 1, "500px", 0);
            }, err => {
                this.loadingData = false;
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Unable to update Message Flag, please contact administrator.", 0, false, 1, "500px", 1);
            });
        }
        else {
    ...
    CancelCompose() {
        if (this.isEdit) {
            ...
            _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Confirm", "Are you sure, you want to discard this message?", 2, false, 0, "500px", 3)
                .subscribe(res => {
                if (res.result == 'yes') {
                    this.isMailDivVisible = true;
                    this.isSentDivVisible = false;
    ...
    UpdateMessageInactive(id) {
        this.loadingData = true;
        this._referrerservice.UpdateMessageInactive(id).subscribe(response => {
            this.loadingData = false;
            this.getIncomingMessageList();
            this.getDeletedIncomingMessageList();
            _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Message Deleted successfully.", 0, false, 1, "500px", 0);
        }, err => {
            this.loadingData = false;
            _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "Unable to Delete, please contact administrator.", 0, false, 1, "500px", 1);
        });
    }
    DeleteMessage(id) {
        this.loadingData = true;
        this._referrerservice.DeleteMessage(id).subscribe(response => {
            this.loadingData = false;
            _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Success", "Message Deleted successfully.", 0, false, 1, "500px", 0);
            this.getDeletedIncomingMessageList();
        }, err => {
    ...
    getSentMessageDetail(SentMessage) {
        // console.log(SentMessageID);
        this._referrerservice.getDirectTrustSentMessageByID(SentMessage.ID).subscribe(res => {
            this.clearComposeEmail();
            this.DTMessageSent = res;
            if (this.DTMessageSent == null || this.DTMessageSent == undefined) {
                _shared_components_modal_ModalStaticClass__WEBPACK_IMPORTED_MODULE_8__["ModalStaticClass"].show(this.modalDialog, "", "Error", "No record found.", 0, false, 1, "500px", 1);
            }
            else {
    ...
    downloadAttachment(attachment) {
        this.loadingData = true;
        this._referrerservice.DownloadMailAttachmentFile(attachment.ID).subscribe(res => {
            var contentType = res.headers.get('content-type');
            var blob = new Blob([res.body], { type: contentType });
            Object(file_saver__WEBPACK_IMPORTED_MODULE_18__["saveAs"])(blob, attachment.FileName);
            //var url = window.URL.createObjectURL(blob);
            //window.open(url);
            res;
            this.loadingData = false;
...
IncomingmessageComponent.ctorParameters = () => [
    { type: src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"] },
    { type: src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"] },
    { type: src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"] },
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('mailInput', null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
], IncomingmessageComponent.prototype, "mailInput", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('ccmailInput', null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])
], IncomingmessageComponent.prototype, "ccmailInput", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('auto', null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_14__["MatAutocomplete"])
], IncomingmessageComponent.prototype, "matAutocomplete", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('ccauto', null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_14__["MatAutocomplete"])
], IncomingmessageComponent.prototype, "ccmatAutocomplete", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatPaginator"])
], IncomingmessageComponent.prototype, "paginator", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"], null),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_material_sort__WEBPACK_IMPORTED_MODULE_6__["MatSort"])
], IncomingmessageComponent.prototype, "sort", void 0);
IncomingmessageComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-incomingmessage',
        template: __importDefault(__webpack_require__(/*! raw-loader!./incomingmessage.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/emrpage/component/incomingmessage/incomingmessage.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./incomingmessage.component.scss */ "./src/app/modules/emrpage/component/incomingmessage/incomingmessage.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_layout_services_application_header_service__WEBPACK_IMPORTED_MODULE_2__["ApplicationHeaderService"], src_app_core_services_storage_helper_service__WEBPACK_IMPORTED_MODULE_3__["StorageHelper"], src_app_layout_services_sidebar_service__WEBPACK_IMPORTED_MODULE_4__["SidebarService"],
        _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_modules_emrpage_services_referral_service__WEBPACK_IMPORTED_MODULE_9__["ReferralService"], _angular_router__WEBPACK_IMPORTED_MODULE_12__["Router"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EMRPageRoutingModule", function() { return EMRPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _component_emraddview_emraddview_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/emraddview/emraddview.component */ "./src/app/modules/emrpage/component/emraddview/emraddview.component.ts");
/* harmony import */ var _component_incomingmessage_incomingmessage_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./component/incomingmessage/incomingmessage.component */ "./src/app/modules/emrpage/component/incomingmessage/incomingmessage.component.ts");
/* harmony import */ var _component_dt_patient_referral_wip_dt_patient_referral_wip_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component/dt-patient-referral-wip/dt-patient-referral-wip.component */ "./src/app/modules/emrpage/component/dt-patient-referral-wip/dt-patient-referral-wip.component.ts");
/* harmony import */ var _component_dtpoc_not_found_dtpoc_not_found_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./component/dtpoc-not-found/dtpoc-not-found.component */ "./src/app/modules/emrpage/component/dtpoc-not-found/dtpoc-not-found.component.ts");
/* harmony import */ var _component_dt_patient_referral_processed_dt_patient_referral_processed_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./component/dt-patient-referral-processed/dt-patient-referral-processed.component */ "./src/app/modules/emrpage/component/dt-patient-referral-processed/dt-patient-referral-processed.component.ts");
/* harmony import */ var _component_dtincoming_message_detail_dtincoming_message_detail_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./component/dtincoming-message-detail/dtincoming-message-detail.component */ "./src/app/modules/emrpage/component/dtincoming-message-detail/dtincoming-message-detail.component.ts");
/* harmony import */ var _component_dt_clinic_user_mapping_dt_clinic_user_mapping_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./component/dt-clinic-user-mapping/dt-clinic-user-mapping.component */ "./src/app/modules/emrpage/component/dt-clinic-user-mapping/dt-clinic-user-mapping.component.ts");
/* harmony import */ var _component_dt_sent_poc_dt_sent_poc_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./component/dt-sent-poc/dt-sent-poc.component */ "./src/app/modules/emrpage/component/dt-sent-poc/dt-sent-poc.component.ts");
/* harmony import */ var _component_dt_plan_care_processed_dt_plan_care_processed_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./component/dt-plan-care-processed/dt-plan-care-processed.component */ "./src/app/modules/emrpage/component/dt-plan-care-processed/dt-plan-care-processed.component.ts");
...
const routes = [
    { path: 'referrer', component: _component_emraddview_emraddview_component__WEBPACK_IMPORTED_MODULE_3__["EMRaddviewComponent"] },
    { path: 'incomingmessage', component: _component_incomingmessage_incomingmessage_component__WEBPACK_IMPORTED_MODULE_4__["IncomingmessageComponent"] },
    { path: 'incomingmessagedetail/:id/:action', component: _component_dtincoming_message_detail_dtincoming_message_detail_component__WEBPACK_IMPORTED_MODULE_8__["DTIncomingMessageDetailComponent"] },
    { path: 'wipmessage', component: _component_dt_patient_referral_wip_dt_patient_referral_wip_component__WEBPACK_IMPORTED_MODULE_5__["DtPatientReferralWIPComponent"] },
    { path: 'dtpocnotfoundmessage', component: _component_dtpoc_not_found_dtpoc_not_found_component__WEBPACK_IMPORTED_MODULE_6__["DTPocNotFoundComponent"] },
    { path: 'processedmessages', component: _component_dt_patient_referral_processed_dt_patient_referral_processed_component__WEBPACK_IMPORTED_MODULE_7__["DtPatientReferralProcessedComponent"] },
    { path: 'sentPocs', component: _component_dt_sent_poc_dt_sent_poc_component__WEBPACK_IMPORTED_MODULE_10__["DtSentPocComponent"] },
    { path: 'ProcessedPocs', component: _component_dt_plan_care_processed_dt_plan_care_processed_component__WEBPACK_IMPORTED_MODULE_11__["DtPlanCareProcessedComponent"] },
    { path: 'clinicmapping', component: _component_dt_clinic_user_mapping_dt_clinic_user_mapping_component__WEBPACK_IMPORTED_MODULE_9__["DtClinicUserMappingComponent"] },
    { path: '', component: _component_emraddview_emraddview_component__WEBPACK_IMPORTED_MODULE_3__["EMRaddviewComponent"] }
];
let EMRPageRoutingModule = class EMRPageRoutingModule {
};
EMRPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EMRPageModule", function() { return EMRPageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _emrpage_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./emrpage-routing.module */ "./src/app/modules/emrpage/emrpage-routing.module.ts");
/* harmony import */ var _component_emraddview_emraddview_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./component/emraddview/emraddview.component */ "./src/app/modules/emrpage/component/emraddview/emraddview.component.ts");
...
/* harmony import */ var _services_referral_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/referral.service */ "./src/app/modules/emrpage/services/referral.service.ts");
/* harmony import */ var _component_incomingmessage_incomingmessage_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./component/incomingmessage/incomingmessage.component */ "./src/app/modules/emrpage/component/incomingmessage/incomingmessage.component.ts");
/* harmony import */ var _component_dt_patient_referral_wip_dt_patient_referral_wip_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./component/dt-patient-referral-wip/dt-patient-referral-wip.component */ "./src/app/modules/emrpage/component/dt-patient-referral-wip/dt-patient-referral-wip.component.ts");
/* harmony import */ var _component_dtpoc_not_found_dtpoc_not_found_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./component/dtpoc-not-found/dtpoc-not-found.component */ "./src/app/modules/emrpage/component/dtpoc-not-found/dtpoc-not-found.component.ts");
/* harmony import */ var _component_dt_patient_referral_processed_dt_patient_referral_processed_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./component/dt-patient-referral-processed/dt-patient-referral-processed.component */ "./src/app/modules/emrpage/component/dt-patient-referral-processed/dt-patient-referral-processed.component.ts");
/* harmony import */ var _component_dtincoming_message_detail_dtincoming_message_detail_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./component/dtincoming-message-detail/dtincoming-message-detail.component */ "./src/app/modules/emrpage/component/dtincoming-message-detail/dtincoming-message-detail.component.ts");
/* harmony import */ var _component_dt_clinic_user_mapping_dt_clinic_user_mapping_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./component/dt-clinic-user-mapping/dt-clinic-user-mapping.component */ "./src/app/modules/emrpage/component/dt-clinic-user-mapping/dt-clinic-user-mapping.component.ts");
/* harmony import */ var angular_archwizard__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! angular-archwizard */ "./node_modules/angular-archwizard/fesm2015/angular-archwizard.js");
/* harmony import */ var _component_dt_sent_poc_dt_sent_poc_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./component/dt-sent-poc/dt-sent-poc.component */ "./src/app/modules/emrpage/component/dt-sent-poc/dt-sent-poc.component.ts");
/* harmony import */ var _component_dt_plan_care_processed_dt_plan_care_processed_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./component/dt-plan-care-processed/dt-plan-care-processed.component */ "./src/app/modules/emrpage/component/dt-plan-care-processed/dt-plan-care-processed.component.ts");
...
let EMRPageModule = class EMRPageModule {
};
EMRPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            _services_referral_service__WEBPACK_IMPORTED_MODULE_6__["ReferralService"],
...
let ReferralService = class ReferralService {
    ...
    saveReferrerDetails(referrerDetails) {
        return this._apiService.postData("CreateReferrer", referrerDetails);
    }
    processIncomingMesssage(processdata) {
        return this._apiService.postData("ProcessIncomingMessage", processdata);
    }
    getPOCList(patientid, operation) {
        return this._apiService.getDataWithParams("PatientPOCs", {
            patientid: patientid,
            operation: operation
        });
    }
    ProcessPOC(patientid, operation, InComingMessageID, noteId, Filename, username, attachmentID) {
    ...
    SaveClinicMapping(clinicmapping) {
    ...
    GetRehabReferrerList(acceptpatient) {
    ...
    getDirectTrustSentMessageByID(sentmessageid) {
        return this._apiService.getDataWithParams("DirectTrustMessageSentByID", {
            sentmessageid: sentmessageid
        });
    }
    DownloadMailAttachmentFile(attachmentID) {
    ...
    getDeletedIncomingMessageList(username, role) {
        return this._apiService.getDataWithParams("DirectTrustDeletedIncomingMessages", {
            username: username,
            role: role
        });
    }
    getIncomingMessageOperation(refID, operation) {
...
ReferralService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=modules-emrpage-emrpage-module-es2015.js.map